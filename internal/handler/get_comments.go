...
func GetComments(commentRepo *repository.CommentRepository) gin.HandlerFunc {
...
func GetCommentsByPostID(commentRepo *repository.CommentRepository) gin.HandlerFunc {
	return func(c *gin.Context) {
